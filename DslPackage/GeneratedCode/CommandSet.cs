...
namespace UPM_IPS.RGRLLCAMSProyectoMDD
{
	...
	/// </summary>
	internal partial class RGRLLCAMSProyectoMDDCommandSet : RGRLLCAMSProyectoMDDCommandSetBase
	{
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDCommandSet.
		/// </summary>
		public RGRLLCAMSProyectoMDDCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class RGRLLCAMSProyectoMDDCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDCommandSetBase.
		/// </summary>
		protected RGRLLCAMSProyectoMDDCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewRGRLLCAMSProyectoMDDExplorerCommand,
				typeof(RGRLLCAMSProyectoMDDEditorFactory).GUID);
		...
		{
			RGRLLCAMSProyectoMDDExplorerToolWindow explorer = this.RGRLLCAMSProyectoMDDExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected RGRLLCAMSProyectoMDDDocData CurrentRGRLLCAMSProyectoMDDDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as RGRLLCAMSProyectoMDDDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected RGRLLCAMSProyectoMDDDocView CurrentRGRLLCAMSProyectoMDDDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as RGRLLCAMSProyectoMDDDocView;
			}
		}
		...
		/// </summary>
		protected RGRLLCAMSProyectoMDDExplorerToolWindow RGRLLCAMSProyectoMDDExplorerToolWindow
		{
			get
			{
				RGRLLCAMSProyectoMDDExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(RGRLLCAMSProyectoMDDExplorerToolWindow), true) as RGRLLCAMSProyectoMDDExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				RGRLLCAMSProyectoMDDExplorerToolWindow explorerWindow = this.RGRLLCAMSProyectoMDDExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class RGRLLCAMSProyectoMDDClipboardCommandSet : RGRLLCAMSProyectoMDDClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDClipboardCommandSet.
		/// </summary>
		public RGRLLCAMSProyectoMDDClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class RGRLLCAMSProyectoMDDClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDClipboardCommandSetBase.
		/// </summary>
		protected RGRLLCAMSProyectoMDDClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
