...
namespace UPM_IPS.RGRLLCAMSProyectoMDD
{
	...
	/// </summary>
	internal partial class RGRLLCAMSProyectoMDDDocData : RGRLLCAMSProyectoMDDDocDataBase
	{
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDDocData.
		/// </summary>
		public RGRLLCAMSProyectoMDDDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a RGRLLCAMSProyectoMDD document in memory.
	/// </summary>
	internal abstract partial class RGRLLCAMSProyectoMDDDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDDocDataBase.
		/// </summary>
		protected RGRLLCAMSProyectoMDDDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::UPM_IPS.RGRLLCAMSProyectoMDD.Tapiz modelRoot = null;
			...
			global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::UPM_IPS.RGRLLCAMSProyectoMDD.Tapiz modelRoot = (global::UPM_IPS.RGRLLCAMSProyectoMDD.Tapiz)this.RootElement;
			...
			{
				global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDiagram diagram = diagrams[0] as global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::UPM_IPS.RGRLLCAMSProyectoMDD.Tapiz modelRoot = this.RootElement as global::UPM_IPS.RGRLLCAMSProyectoMDD.Tapiz;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
