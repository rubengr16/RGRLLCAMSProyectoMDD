...
namespace UPM_IPS.RGRLLCAMSProyectoMDD
{
	...
	/// </summary>
	internal partial class RGRLLCAMSProyectoMDDDocView : RGRLLCAMSProyectoMDDDocViewBase
	{
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDDocView.
		/// </summary>
		public RGRLLCAMSProyectoMDDDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RGRLLCAMSProyectoMDDDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDDocView.
		/// </summary>
		protected RGRLLCAMSProyectoMDDDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			RGRLLCAMSProyectoMDDDocDataBase docData = this.DocData as RGRLLCAMSProyectoMDDDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for RGRLLCAMSProyectoMDDDocViewBase should be an RGRLLCAMSProyectoMDDDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.RGRLLCAMSProyectoMDDDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.RGRLLCAMSProyectoMDD.RGRLLCAMSProyectoMDDHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
