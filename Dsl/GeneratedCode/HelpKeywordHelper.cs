...
namespace UPM_IPS.RGRLLCAMSProyectoMDD
{
	...
	/// </remarks>
	public partial class RGRLLCAMSProyectoMDDHelpKeywordHelper : RGRLLCAMSProyectoMDDHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDHelpKeywordHelper.
		/// </summary>
		protected RGRLLCAMSProyectoMDDHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the RGRLLCAMSProyectoMDDHelpKeywordHelper.
		/// </summary>
		public static RGRLLCAMSProyectoMDDHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class RGRLLCAMSProyectoMDDHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new RGRLLCAMSProyectoMDDHelpKeywordHelperBase.
		/// </summary>
		protected RGRLLCAMSProyectoMDDHelpKeywordHelperBase()
			: base() { }
